...
const devBase = import.meta.env.VITE_API_URL ?? `http://${hostname}:8001/api`;
...
const LoginRouter = () => {
  ...
  return (
    <main>
      ...
      {!infoLoading && <div className="fixed text-sm right-2 bottom-1 font-light">Metro CCDC Individual Scoreboard v{info.version}</div>}
    </main>
  )
};
